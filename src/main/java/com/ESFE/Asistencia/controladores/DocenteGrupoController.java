...
import com.ESFE.Asistencia.servicios.interfaces.iDocenteGrupoServices;
...
public class DocenteGrupoController {
    ...
    public String save(@RequestParam Integer docenteId,
        ...
        Docente docente = docenteServices.BuscarPorId(docenteId)
    ...
    public String details(@PathVariable("id") Integer id, Model model) {
        DocenteGrupo docenteGrupo = docenteGrupoService.BuscarPorId(id)
                .orElseThrow(() -> new RuntimeException("DocenteGrupo no encontrado"));
        model.addAttribute("docenteGrupo", docenteGrupo);
